# Tutorial de Instalação do Oracle APEX 24.2+ / 26ai (Local - Mac)
...
1. Certifique-se de ter o Docker, Docker Compose e Colima instalados no seu Mac.
...
Para não consumir toda a memória RAM do seu Mac quando não estiver trabalhando, use os scripts:
...
> Se a tela do APEX aparecer "quebrada" ou sem estilo de CSS após uma atualização, não se desespere! O seu navegador salvou o estilo antigo. Basta pressionar **Cmd + Shift + R** (ou acessar em janela anônima) para forçar o carregamento do visual novo correto.
